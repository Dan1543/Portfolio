...
For this system, the **ESP32-WROOM-32D** was selected as the main controller. Beyond its cost-effectiveness, it was chosen for its integrated **Wi-Fi and Bluetooth** capabilities and its low-power **Deep Sleep modes**, which are critical for IoT edge devices sending data to cloud services like **AWS IoT Core**.
